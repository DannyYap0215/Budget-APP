...
def open_set_income_window():
    ...
    income_label.grid(row=3, column=0, padx=10, pady=5, sticky="w")
    income_entry = CTkEntry(set_income_window)
    income_entry.grid(row=3, column=1, padx=10, pady=5)
  
    month_issued_label = CTkLabel(set_income_window, text="Month Issued:",font=CTkFont("font/Poppins-Bold.ttf",20))
    month_issued_label.grid(row=2, column=0, padx=10, pady=(5,30), sticky="w")
    ...
    choose_month_button = CTkButton(set_income_window, text="Confirm Month ",fg_color="#6965A3", bg_color="#1f2124", command=save_month)
    choose_month_button.grid(row=2, column=2, padx=10, pady=(5,30))
    
    choose_year_button = CTkButton(set_income_window, text="Confirm Year",fg_color="#6965A3", bg_color="#1f2124", command=save_year)
    choose_year_button.grid(row=1, column=2)
  
    save_button = CTkButton(set_income_window, text="Save ALL",fg_color="#6965A3", bg_color="#1f2124", command=save_budget)
